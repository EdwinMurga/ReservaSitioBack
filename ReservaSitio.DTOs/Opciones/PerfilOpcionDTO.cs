...
namespace ReservaSitio.DTOs.Opciones
{
    ...
    public class menuOpcions_Obj
    {
        public menu_Obj MenuObj { get; set; }
        public List<subMenu_Obj> SubMenuObjs { get; set; }

        public menuOpcions_Obj()
        {
            MenuObj = new menu_Obj();
            SubMenuObjs = new List<subMenu_Obj>();
        }
    }

    public class subMenu_Obj
    {
        public string text { get; set; }
        public string descripcion { get; set; }
        public string link { get; set; }
